...
export default function ThanksPage() {
  return (
    <PageShell
      ...
      nextPage={0}
      prevHref="/Projects"
      containerClassName="relative flex min-h-screen select-none flex-col items-center justify-start px-4 pb-16 pt-24 duration-300 sm:px-6 md:px-8 md:pt-28 lg:px-12 lg:pb-20 xl:px-16 xl:pl-[280px]"
      contentClassName="relative z-[2] mt-6 flex w-full max-w-[1640px] flex-col gap-8 text-textLight md:gap-10"
    >
      <motion.section
        {...reveal}
        className="grid gap-6 2xl:grid-cols-[1.2fr_0.8fr]"
      >
        <div className="theme-panel-highlight overflow-hidden rounded-[34px] border shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
          <CodeSection
            tag="thanks"
          ...
          >
            <div className="space-y-4">
              ...
              <p className="max-w-3xl text-sm leading-7 text-textLight md:text-base">
        ...
        <div className="grid gap-6">
          <motion.div
            ...
            className="theme-card-strong overflow-hidden rounded-[30px] border p-6 shadow-[0_18px_60px_rgba(0,0,0,0.28)]"
          >
            <CodeSection
              tag="connect"
      ...
      <motion.section
        ...
        className="grid gap-6 2xl:grid-cols-[0.94fr_1.06fr]"
      >
        <div className="theme-band-surface overflow-hidden rounded-[30px] border p-6 md:p-8">
          ...
          >
            {collaborationNotes.map((note) => (
              <p key={note} className="text-sm leading-7 text-textLight md:text-base">
                {note}
              </p>
            ))}
          </CodeSection>
        ...
        <div className="theme-panel-highlight overflow-hidden rounded-[30px] border p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)] md:p-8">
          <CodeSection
            tag="credits"
          ...
          >
            ...
            <p className="text-sm leading-7 text-textWhite md:text-base">
